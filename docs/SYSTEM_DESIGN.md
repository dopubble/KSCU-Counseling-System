...
숭실사이버대학교 평생교육원 전문상담센터는 내담자의 상담 신청부터 상담사 매칭, 예약, Zoom 화상 상담, 상담일지·사례관리, 종결보고서 작성까지 전 과정을 디지털로 관리하는 통합 플랫폼이 필요하다.
